...
void hpyr_backend_init(hpyr_backend *pb, char *pname, int w, int h)
{
        ...
        VkDeviceCreateInfo device_info = {
                ...
                .ppEnabledExtensionNames = (char *[]) {"VK_KHR_swapchain",
        ...
        vkGetDeviceQueue(pb->ldevice, 0, 0, &pb->pqueues[HPYR_BACKEND_IDX_COMPUTE_QUEUE]);
        vkGetDeviceQueue(
        ...
        VK_TRY(vkCreateSwapchainKHR(
                ...
                &(VkSwapchainCreateInfoKHR) {
                        ...
                        .surface          = pb->surface,
                        .minImageCount    = 2,
                        .imageFormat      = hpyr_context_SWAPCHAIN_IMAGE_FORMAT,
        ...
        VK_TRY(vkGetSwapchainImagesKHR(
                pb->ldevice, pb->swapchain, &pb->nswapchain_images, NULL));
        pb->pswapchain_images = malloc(sizeof(VkImage) * pb->nswapchain_images);
        VK_TRY(vkGetSwapchainImagesKHR(
                pb->ldevice,
                pb->swapchain,
                &pb->nswapchain_images,
                pb->pswapchain_images));
...
VkShaderModule hpyr_backend_init_shader_module(
...
void hpyr_backend_cmd_simple_transition(
        ...
        VkImageLayout new)
{
        assert(pr && VK_NULL_HANDLE != cmd_buf && VK_NULL_HANDLE != img);
        ...
        VkDeviceSize size)
{
        ...
        VK_TRY(vkCmdPipelineBarrier(
                cmd_buf, src_stage, dst_stage, deps, 0, NULL, 1, &bar, 0, NULL));
}

uint32_t hpyr_backend_find_idx_memory_type(hpyr_backend *pb, VkMemoryRequirements *preq)
{
}

VkImage hypr_backend_next_image(
...
void hpyr_backend_simple_submit(
        ...
        VkPipelineStageFlags *pstage,
        uint32_t nsig_sema,
        VkSemaphore *psig_sema,
        VkFence fence)
{
        VkSubmitInfo info = {
                ...
                .pWaitDstStageMask    = pstage,
                .commandBufferCount   = 1,
                .pCommandBuffers      = &cmd_buf,
                .signalSemaphoreCount = nsig_sema,
                .pSignalSemaphores    = psig_sema};
